...
func _ready() -> void:
	...
	GameManager.update_score.connect(_on_game_manager_update_score)
	GameManager.ui_visible.connect(_on_game_manager_ui_visible)
	GameManager.current_ammo.connect(_on_game_manager_current_ammo)
	GameManager.killstreak.connect(_on_game_manager_killstreak)
